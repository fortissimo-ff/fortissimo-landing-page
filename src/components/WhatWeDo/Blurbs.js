    ...
    return (
      <div>
        ...
        <div className = "blurbDivs">
          ...
          <img className = "RightBlurbImages" src={require("../../img/img-clipart-wwd-question.png")} alt="question mark"/>
        ...
        <div className = "blurbDivs">
          ...
          <img className = "LeftBlurbImages" src={require("../../img/img-clipart-wwd-money.png")} alt="money"/>
        ...
        <div className = "blurbDivs">
          ...
          <img className = "RightBlurbImages" src={require("../../img/img-clipart-wwd-percent.png")} alt="percentage"/>
